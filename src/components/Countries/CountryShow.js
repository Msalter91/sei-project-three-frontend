...
function CountryShow () {
  ...
  return (
    <div className='container-fluid h-100' style={{ border: '1px solid red' }}>
      ...
      <div className='row'>
        <div className='col'>
          {!memory.trips[0] && <p>Looks like there are no adventures here yet</p> }
          {memory.trips[0] && <p>This is where cards would go that are full of images</p>}
        </div>
      </div>
    </div>
  )
